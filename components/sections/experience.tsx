  ...
  return (
    <div className="space-y-4">
      ...
      <div className="border-l-2 border-ctp-peach pl-4 py-1">
        ...
        <div className={`text-ctp-text ${textSize}`}>KS Softech Private Limited</div>
      ...
      <div className="border-l-2 border-ctp-peach pl-4 py-1">
        ...
        <div className={`text-ctp-text ${textSize}`}>Healing Up</div>
        <div className={`text-ctp-subtext0 ${isMobile ? "text-xs" : "text-sm"}`}>April 2024 – July 2024</div>
        <div className={`text-ctp-text mt-1 ${textSize}`}>
          <ul className="list-disc pl-5 space-y-1">
            <li>
              Reactive Web designs delivered in Figma with precision, meeting and maintaining a 45-day project cycle
              with HTML and CSS integration.
            </li>
            <li>
              Led a team of developers by encouraging collaboration, improving the quality of the product and achieving
              a project completion rate of 100%.
            </li>
          </ul>
        </div>
      </div>
