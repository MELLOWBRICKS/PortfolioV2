  ...
  return (
    <div className="space-y-4">
      ...
      <div className="border-l-2 border-ctp-green pl-4 py-1">
        ...
        <div className={`text-ctp-blue ${isMobile ? "text-xs" : "text-sm"} mt-1`}><a href="https://github.com/mellowbricks/Computer-Association-Website">GitHub Link</a></div>
      </div>
      ...
      <div className="border-l-2 border-ctp-green pl-4 py-1">
        ...
        <div className={`text-ctp-blue ${isMobile ? "text-xs" : "text-sm"} mt-1`}><a href="https://ca-chatbot.onrender.com/">CA-ChatBot</a></div>
      </div>
